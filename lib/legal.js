...
export const LEGAL = {
  ...
  // VAT: the operator is a small business under the German Kleinunternehmerregelung (§19 UStG)
  // and therefore has no VAT identification number. (As Merchant of Record, Polar collects and
  // remits any consumer VAT regardless — see the Billing Terms.) `vatId` is null when none exists.
  vatId: null,
  vatNote: "Kleinunternehmer gemäß § 19 UStG — keine Umsatzsteuer-Identifikationsnummer (USt-IdNr.) vorhanden.",
