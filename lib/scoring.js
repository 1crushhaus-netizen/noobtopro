...
// — the question's band difficulty is no more than one rank band (SCORE_MAX/5) below the
...
export function attemptVerifies(band, score) {
  const d = defaultDifficultyForBand(band);
