...
// ---------------------------------------------------------------------------
// CONCEPT-HUB PUBLIC SEED (PR 4). One canonical "core concept" per taxonomy topic
// (36 total). The seed script (scripts/seed-concept-hub.mjs) generates a curated
// guide for each via Groq and publishes it through the seed_curated_guide RPC, so
// the hub is the SAME vetted catalog for everyone from day one (the curation-only
// model otherwise leaves a fresh user's hub empty). Keep one entry per topic slug.
// ---------------------------------------------------------------------------
export const SEED_CONCEPTS = {
  math: [
    { slug: "arithmetic_number", concept: "Prime factorization" },
    { slug: "algebra", concept: "Solving linear equations" },
    { slug: "functions_precalc", concept: "Function composition" },
    { slug: "geometry", concept: "The Pythagorean theorem" },
    { slug: "trigonometry", concept: "The unit circle" },
    { slug: "calculus_analysis", concept: "The derivative as a rate of change" },
    { slug: "linear_algebra", concept: "Matrix multiplication" },
    { slug: "differential_equations", concept: "Separable differential equations" },
    { slug: "probability_statistics", concept: "Conditional probability" },
    { slug: "discrete_logic", concept: "Proof by induction" },
    { slug: "proof_reasoning", concept: "Direct versus indirect proof" },
    { slug: "general_math", concept: "Problem-solving strategies in mathematics" },
  ],
  physics: [
    { slug: "kinematics_dynamics", concept: "Newton's second law" },
    { slug: "energy_momentum", concept: "Conservation of energy" },
    { slug: "gravitation_orbits", concept: "Newton's law of universal gravitation" },
    { slug: "oscillations_waves", concept: "Simple harmonic motion" },
    { slug: "fluids_continuum", concept: "Bernoulli's principle" },
    { slug: "thermodynamics_statmech", concept: "The first law of thermodynamics" },
    { slug: "electromagnetism", concept: "Coulomb's law" },
    { slug: "optics", concept: "Refraction and Snell's law" },
    { slug: "modern_quantum", concept: "Wave-particle duality" },
    { slug: "relativity", concept: "Time dilation" },
    { slug: "nuclear_particle", concept: "Radioactive decay" },
    { slug: "general_physics", concept: "Dimensional analysis" },
  ],
  chemistry: [
    { slug: "atomic_structure", concept: "Electron configuration" },
    { slug: "bonding_molecular", concept: "Covalent versus ionic bonding" },
    { slug: "stoichiometry", concept: "Limiting reagents" },
    { slug: "states_intermolecular", concept: "Intermolecular forces" },
    { slug: "thermochemistry", concept: "Enthalpy of reaction" },
    { slug: "equilibrium", concept: "Le Chatelier's principle" },
    { slug: "acids_bases", concept: "The pH scale" },
    { slug: "kinetics", concept: "Reaction rate and rate laws" },
    { slug: "electrochemistry", concept: "Redox reactions" },
    { slug: "organic", concept: "Functional groups" },
    { slug: "analytical_spectroscopy", concept: "The Beer-Lambert law" },
    { slug: "general_chemistry", concept: "The mole concept" },
  ],
};

// Flatten SEED_CONCEPTS to [{subject, slug, concept}] for the seed batch.
export function allSeedConcepts() {
  return ORDER.flatMap((subject) =>
    (SEED_CONCEPTS[subject] || []).map((c) => ({ subject, slug: c.slug, concept: c.concept }))
  );
}
