...
export const PHYSICS_DIAGNOSTIC_ITEMS = [
  {
    ...
    subject: "physics", band: "beginner", conceptKey: "pushes_pulls", topic: "Forces", topicSlug: "kinematics_dynamics",
  ...
  },
  {
    ...
    subject: "physics", band: "advanced", conceptKey: "vectors_kinematics_calc", topic: "Motion under gravity", topicSlug: "kinematics_dynamics",
