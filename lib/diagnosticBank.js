...
// items per (subject, band) cell across ALL FIVE bands (a ±1 walk of 4 steps
...
// §8 decisions (owner, 2026-06-11): 4 steps per subject; start at the middle
// band; quality ≥ the threshold moves one band up, below moves one band down.
export const DIAG_STEPS_PER_SUBJECT = 4;
...
// asked (unreachable on a well-formed 4-step walk; two per cell suffice).
