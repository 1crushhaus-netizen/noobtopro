...
Set \`finalAnswerMatches\` (DIAGNOSTIC ONLY — it must not directly move any axis).
...
{"solve":{"principle":"<principle + why>","steps":["<step with units>","..."],"finalAnswer":"<result>","units":"<units>"},"subject":"<subject>","rubric":{"comprehension":<0-4>,"principle":<0-4>,"justification":<0-4>,"strategy":<0-4>,"logic":<0-4>,"execution_method":<0-4>,"computation":<0-4>,"verification":<0-4>,"communication":<0-4>},"errors":[{"type":"conceptual|strategic|reasoning|execution-slip|communication","step":"<part of the learner's work>","severity":"minor|major","what":"<=20 words","feedbackMode":"point|reteach|socratic","message":"<type-matched; for reasoning errors do NOT reveal the correction>","socraticPrompt":"<question; '' unless socratic>"}],"finalAnswerMatches":<true|false>,"weakConcepts":["..."],"comment":"<=35 words on what their reasoning showed (NO worked solution, NO final answer)>"}`;
...
Set \`finalAnswerMatches\` to whether the learner's final answer matches yours — DIAGNOSTIC ONLY; it must not directly move any axis.
 ...
 */
export async function groqJSON({ system, user, image, maxTokens, grade, temperature: temperatureOpt, seed: seedOpt }) {
